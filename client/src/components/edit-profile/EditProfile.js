...
class EditProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      profile.yearsPlayedMusic = !isEmpty(profile.yearsPlayedMusic)
        ? profile.yearsPlayedMusic
        : "";
      profile.gigsPlayed = !isEmpty(profile.gigsPlayed)
        ? profile.gigsPlayed
        : "";
      profile.availableToRehearse = !isEmpty(profile.availableToRehearse)
        ? profile.availableToRehearse
        : "";
      profile.availableToGig = !isEmpty(profile.availableToGig)
        ? profile.availableToGig
        : "";
      profile.recordingExperience = !isEmpty(profile.recordingExperience)
        ? profile.recordingExperience
        : false;
      profile.lookingForBand = !isEmpty(profile.lookingForBand)
        ? profile.lookingForBand
        : false;
      profile.lookingForBandmates = !isEmpty(profile.lookingForBandmates)
        ? profile.lookingForBandmates
        : false;
      profile.instruments = !isEmpty(profile.instruments)
        ? profile.instruments
        : [];
      ...
      <React.Fragment>
        <div>
          ...
          <input
            ...
            autoComplete="off"
            className={
              "social-input-website " + (errors.website ? "input-error" : "")
            }
          />
          {errors.website && (
            <small className="input-error-message">{errors.website}</small>
          )}
        </div>
        <div>
          ...
          <input
            ...
            autoComplete="off"
            className={
              "social-input-facebook " + (errors.facebook ? "input-error" : "")
            }
          />
          {errors.facebook && (
            <small className="input-error-message">{errors.facebook}</small>
          )}
        </div>
        <div>
          <label>Twitter</label>
          <input
            ...
            autoComplete="off"
            className={
              "social-input-twitter " + (errors.twitter ? "input-error" : "")
            }
          />
          {errors.twitter && (
            <small className="input-error-message">{errors.twitter}</small>
          )}
        </div>
        <div>
          <label>YouTube</label>
          <input
            ...
            autoComplete="off"
            className={
              "social-input-youtube " + (errors.youtube ? "input-error" : "")
            }
          />
          {errors.youtube && (
            <small className="input-error-message">{errors.youtube}</small>
          )}
        </div>
        <div>
          ...
          <input
            ...
            autoComplete="off"
            className={
              "social-input-soundcloud " +
              (errors.soundcloud ? "input-error" : "")
            }
          />
          {errors.soundcloud && (
            <small className="input-error-message">{errors.soundcloud}</small>
          )}
        </div>
        <div>
          ...
          <input
            ...
            autoComplete="off"
            className={
              "social-input-bandcamp " + (errors.bandcamp ? "input-error" : "")
            }
          />
          {errors.bandcamp && (
            <small className="input-error-message">{errors.bandcamp}</small>
          )}
        </div>
      </React.Fragment>
    );
          ...
          <div className="form-inner">
            ...
            >
              ...
              <div className="form-body">
                <div>
                  <label>
                    Handle <span className="required-icon">*</span>
                  </label>
                  <input
                    disabled
                    onChange={this.handleChange}
                ...
                <div>
                  ...
                  <select
                    className="form-select"
                    value={this.state.yearsPlayedMusic}
                    onChange={this.handleChange}
                    name="yearsPlayedMusic"
                  >
                    <option value=""></option>
                ...
                <div>
                  ...
                  <select
                    className="form-select"
                    value={this.state.availableToRehearse}
                    onChange={this.handleChange}
                    name="availableToRehearse"
                  >
                    <option value=""></option>
                ...
                <div>
                  ...
                  <select
                    className="form-select"
                    value={this.state.availableToGig}
                    onChange={this.handleChange}
                    name="availableToGig"
                  >
                    <option value=""></option>
              ...
              <button className="button button-darkblue" type="submit">
                Confirm
              </button>
            </form>
          </div>
